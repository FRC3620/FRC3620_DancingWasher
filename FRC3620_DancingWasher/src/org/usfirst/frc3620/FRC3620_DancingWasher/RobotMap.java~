...
public class RobotMap {
    ...
    public static Gyro driveMecanumGyro;
    ...
    public static void init() {
        ...
        driveMecanumGyro = new Gyro(0);
        LiveWindow.addSensor("Drive", "MecanumGyro", driveMecanumGyro);
        driveMecanumGyro.setSensitivity(0.007);
