 ...
 *
 */
public class  FillTankCommand2 extends Command {
	RumbleCommand rumbleCommand = new RumbleCommand();

    public FillTankCommand2() {
    ...
    protected void execute() {
    	ShootingSystemState currentState = Robot.shooterSubsystem.getShootingSystemState2();
    	if (currentState == ShootingSystemState.IDLE) {
    		Robot.shooterSubsystem.setShootingSystemState2(ShootingSystemState.FILLING);
    	} else if (currentState == ShootingSystemState.FILLING) {
    		Robot.shooterSubsystem.setShootingSystemState2(ShootingSystemState.ALLREADY);
    	} else {
