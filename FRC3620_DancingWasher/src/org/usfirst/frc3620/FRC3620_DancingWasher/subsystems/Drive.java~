...
public class Drive extends Subsystem {
    ...
    Gyro mecanumGyro = RobotMap.driveMecanumGyro;
    ...
    public void mecanumDrive_Polar(GenericHID hid)
    {
         ...
         double gyro = mecanumGyro.getAngle();
    ...
    public void spin(double spinSpeed, double degrees)
    {
    	double speed = Math.abs(spinSpeed);
    	if(degrees < 0)
    	{
    		speed = speed*-1;
    	}
    	System.out.println("GyroAngle: " + mecanumGyro.getAngle());
    	System.out.println("degreesToSpin: " + degrees);
    	setDrive(0, 0, speed, 0);
    }
    
    double move = Math.random();
    
    public void shakeLeft(int previousMove)
    {
    	System.out.println("Shake Left");
    	if (previousMove == 1)
    	{
    		Robot.drive.spin(1, -120);
    	}
    	else
    	{
    		Robot.drive.spin(1, -60);
    	}
    }
    
    public void shakeRight(int previousMove)
    {
    	System.out.println("Shake Right");
    	if (previousMove == 2)
    	{
    		Robot.drive.spin(1, 120);
    	}
    ...
    public void pickMove(int prevCommand)
    {
    	move = Math.random();
    	System.out.println("Prev Move: " + previousMove);
    	System.out.println("Prev Command: " + prevCommand);
